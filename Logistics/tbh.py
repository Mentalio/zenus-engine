...
class textbox:
    ...
    def check_keys_merged(self, event: pygame.event.Event):
        """
        Checking all the events is tedious check keys alone was deleted. Sorry!
        This can shave of the operations of going through the entirety of the events
        """
        if self.clicked:
